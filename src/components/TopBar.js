    ...
    <div>
        <Navbar style={{display: 'flex', justifyContent: 'space-between'}} bg="light" expand="lg" >
            <Navbar.Brand style={{margin: "5px 0 0 20px"}} href="#home">
                <img style={{width: "100px"}} src={Instacart} alt="Instacart Logo" /> 
            </Navbar.Brand>
            ...
            <Navbar.Collapse id="basic-navbar-nav">
                ...
                <Nav style={{ padding: "24px 40px 20px 40px", fontSize: "18px", lineHeight: "26px", fontWeight: "bolder", display: "flex", justifyContent: "flex-end" }} >
                    ...
                    <Button variant="success" style={{fontSize: "18px", backgroundColor: "#04c20a", borderRadius: "20px", height: "45px", width: "90px", color: "white", border: "none"}}>Sign Up</Button>{' '}
                </Nav>
            </Navbar.Collapse>
        </Navbar>
    </div>
